...
数据驱动的新媒体运营人，专注抖音、小红书、快手平台的内容策略与流量增长。拥有**蔚来汽车**、**去哪儿旅行**、**Shopee** 等头部互联网企业实习经历，擅长直播全链路运营、AI工具批量内容创作与自动化工作流搭建。
...
| 序号 | 项目 | 链接 | 说明 |
|:---:|------|:---|------|
| 1 | 日本旅行攻略网站 | [🔗 打开](https://whimsical-macaron-eb27fb.netlify.app) | 一个超全的日本旅行攻略网站 |
| 2 | 午餐盲盒创意站 | [🔗 打开](https://loquacious-tanuki-66c3c4.netlify.app) | 午餐不知道吃什么就点开这个网站吧，超有趣的抽盲盒形式哦，还能搜集你的专属美食卡片 |
...
| 序号 | 项目 | 说明 |
|:---:|------|------|
| 1 | 个人网站搭建 Skill | 从简历到部署的一键建站工作流 |
| 2 | 视频分析 Skill | 一个能帮你分析视频的skill → [查看](https://www.douyin.com/video/7657490464265874408) |
